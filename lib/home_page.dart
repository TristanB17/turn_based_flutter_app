...
import 'package:flutter_turn_based_logic/custom_dialogue.dart';
  ...
  int checkWinner() {
    ...
    if (winner != -1) {
      if (winner == 1) {
        showDialog(
          context: context,
          builder: (_)=> new CustomDialogue('Player 1 Won!!', 'Press the Reset Button to Start again.', resetGame),
        ); 
      } else {
        showDialog(
          context: context,
          builder: (_)=> new CustomDialogue('Player 2 Won!!', 'Press the Reset Button to Start again.', resetGame),
        ); 
      }
    }
    return winner; 
